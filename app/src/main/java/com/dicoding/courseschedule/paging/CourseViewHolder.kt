...
class CourseViewHolder(view: View): RecyclerView.ViewHolder(view) {
    val nameTv : TextView = itemView.findViewById(R.id.tv_course)
    val timeTv : TextView = itemView.findViewById(R.id.tv_time)
    val lecturerTv : TextView = itemView.findViewById(R.id.tv_lecturer)
    ...
    fun bind(course: Course, clickListener: (Course) -> Unit) {
        ...
        course.apply {
            ...
            nameTv.text = courseName
            timeTv.text = timeFormat
            lecturerTv.text = lecturer
        }
